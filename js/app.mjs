 ...
 *
 * If you have any questions related to code, you can drop them in my email
 * or in my email at akrk053@gmail.com
 *
...
fetch(
  'https://api.github.com/repos/BOT9315/text-to-handwriting/contributors'
)
  .then((res) => res.json())
  .then((res) => {
